...
| **P3** | [**multi-agent-orchestration v0.3.0**](https://github.com/pabloalvarez99/multi-agent-orchestration/releases/tag/v0.3.0) | Can specialists hand work off under shared policy, isolation, offline replay, and budgets? | **v0.3.0 LIVE** |
