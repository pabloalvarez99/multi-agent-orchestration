...
| **P3** | [**multi-agent-orchestration v0.2.0**](https://github.com/pabloalvarez99/multi-agent-orchestration/releases/tag/v0.2.0) | Can specialists hand work off under shared policy, isolation, replay, and budgets? | **v0.2.0 LIVE** |
